...
the genome of other Koreans. Other laboratores might have their own
...
recompress it using the target reference as the reference
...
\begin{center}
  ...
  \footnotesize{Figure-\arabic{figure}: Comparison of compression
    ...
    on certain chromosomes sequenced from Korean individuals.}
